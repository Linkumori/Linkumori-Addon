...
| Category | Files |
|----------|-------| 
| **JavaScript** | `external_js/IP-Ranger.js`<br>`external_js/linkumori-i18n.js`<br>`external_js/linkumori_lz4_block.js`<br>`external_js/theme_bootstrap.js`<br>`external_js/theme_favicon.js`<br>`core_js/clipboard-helper.js`<br>`core_js/accessibility_tools.js`<br>`core_js/about.js`<br>`core_js/consent_config.js`<br>`core_js/content_script_manager.js`<br>`core_js/audit.js`<br>`core_js/modal_dialog.js`<br>`core_js/linkumori_dns.js`<br>`core_js/linkumori_rule_ids.js`<br>`core_js/linkumori_rule_pins.js`<br>`core_js/regression_page.js`<br>`html/guide.js` |
| **HTML** | `html/regression.html`<br>`html/guide.html` |
| **CSS** | `css/settings.css`<br>`css/siteBlockedAlert.css`<br>`css/wcag-aa.css` |
...
### 1.4 Shared Accessibility Tools (`core_js/accessibility_tools.js`, `css/wcag-aa.css`)

**Description:** Shared first-party accessibility tools used by extension HTML pages, including contrast controls, link highlighting, text sizing, text spacing, line-height adjustment, image hiding, big cursor mode, synchronized preferences, and live updates across open pages.

**Copyright:** © 2026 Subham Mahesh
...
|------|--------|
| **Original** | ClearURLs Team |
| **Japanese Translation** | © 2026 Subham Mahesh |
...
|------|--------|
| **Original** | ClearURLs Team |
| **Korean Translation** | © 2026 Subham Mahesh |
...
##### Dutch (`_locales/nl/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Dutch Translation** | © 2026 Subham Mahesh |
...
##### Ukrainian (`_locales/uk/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Ukrainian Translation** | © 2026 Subham Mahesh |
...
##### Chinese Simplified (`_locales/zh_CN/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Chinese Simplified Translation** | © 2026 Subham Mahesh |
...
##### Polish (`_locales/pl/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Polish Translation** | © 2026 Subham Mahesh |
...
##### Portuguese (Portugal) (`_locales/pt_PT/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Portuguese (Portugal) Translation** | © 2026 Subham Mahesh |
...
##### Portuguese (Brazil) (`_locales/pt_BR/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Portuguese (Brazil) Translation** | © 2026 Subham Mahesh |
...
##### Slovenian (`_locales/sl/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Slovenian Translation** | © 2026 Subham Mahesh |
...
##### Swedish (`_locales/sv/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Swedish Translation** | © 2026 Subham Mahesh |
...
##### Thai (`_locales/th/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Thai Translation** | © 2026 Subham Mahesh |
...
##### Turkish (`_locales/tr/messages.json`)
...
|------|--------|
| **Original** | ClearURLs Team |
| **Turkish Translation** | © 2026 Subham Mahesh |
